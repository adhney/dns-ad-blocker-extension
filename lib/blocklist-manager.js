    ...
    this.defaultLists = [
      {
        ...
        description: "General ad blocking list",
      },
      {
        name: "AdGuard DNS",
        url: "https://adguardteam.github.io/AdGuardSDNSFilter/Filters/filter.txt",
        description: "Optimized for DNS blocking",
      },
      {
        name: "Common Ads",
        url: "built-in:common-ads",
        description: "Built-in list of common ad domains",
      },
      {
        name: "Trackers",
        url: "built-in:trackers",
        description: "Built-in list of tracking domains",
      },
    ];
  }
